...
class VideosTest extends BrowserKitTestCase
{
    ...
    public function a_video_can_supply_its_own_embed_html()
    {
        ...
        $expected = '<iframe class="absolute inset w-full h-full" src="https://player.vimeo.com/video/12345" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';

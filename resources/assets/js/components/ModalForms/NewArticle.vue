<template>
    <span>
        <button class="dd-btn"
                @click="showForm = true">New Article</button>
        <modal :show="showForm"
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="my-6">
                        ...
                        <div class="flex">
                            ...
                            <div class="mx-6">
                                <label for="zh_title_locale"
                                       class="form-label">Chinese</label>
                                <input type="radio"
                                       v-model="formData.lang"
                                       value="zh"
                                       id="zh_title_locale">
                  ...
                  <div class="my-6">
                      <span class="form-label">This article belongs to:</span>
                        <div class="flex">
                            <div>
                                <label for="designation_taiwan"
                                       class="form-label">Taiwan</label>
                                <input type="radio"
                                       v-model="formData.designation"
                                       value="taiwan"
                                       id="designation_taiwan">
                            </div>
                            <div class="mx-6">
                                <label for="designation_world"
                                       class="form-label">World</label>
                                <input type="radio"
                                       v-model="formData.designation"
                                       value="world"
                                       id="designation_world">
                            </div>
                        </div>
                  </div>
                    <div class="mt-6 flex justify-end">
                        <button class="dd-btn btn-grey"
                                type="button"

...
@section('content')
    <section class="cover-splash">
        ...
        <a href="{{ localUrl('/articles/' . $featured->slug) }}" class="cover-link"><span class="white-text serif-text">{{ trans('homepage.splash.button') }}</span></a>
        @endif
    </section>
    <section class="page-section articles-section">
        ...
        <a href="#" class="section-cta dd-btn block">{{ trans('homepage.articles.button') }}</a>
    </section>
    <section class="page-section photos-and-art-section">
        ...
        <a href="#" class="section-cta dd-btn block">{{ trans('homepage.photos.button') }}</a>
    </section>
    <section class="page-section videos-section">
        ...
        <a href="#" class="section-cta dd-btn block">{{ trans('homepage.videos.button') }}</a>
    </section>
    <section class="page-section bios-section">
        ...
        <a href="#" class="section-cta dd-btn block">{{ trans('homepage.contributors.button') }}</a>
    </section>
    <section class="page-section affiliates-section">
        ...
        <a href="#" class="section-cta dd-btn block">{{ trans('homepage.affiliates.button') }}</a>
    </section>
@endsection
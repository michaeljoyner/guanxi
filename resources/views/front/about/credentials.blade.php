<section id="credentials" class="py-10 px-6">
    <h1 class="type-h1 text-center mb-20">{{ trans('about.credentials.title') }}</h1>

    <div class="text-center">
        <p class="mb-4">{{ trans('about.credentials.members_of') }}:</p>
